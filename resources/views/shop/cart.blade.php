                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="{{url('public/images/'.$p->image)}}" class="recent-thumb" alt="">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="">
                                              <img width="145" 
                                                   ...
                                                   src="{{url('public/images/'.$item->image)}}">
                                                   </a>
                                        </td>
                                            ...
                                            <td class="actions" colspan="6">
                                                <div class="coupon">
                                                    <form action="cart/{{$item->rowId}}/update" method="post">
                                                      ...
                                                      <input type="text" placeholder="Coupon code" value="{{$item->price}}" id="coupon_code" class="input-text" name="coupon_code">
                                                      <input type="submit" value="Apply Coupon" name="apply_coupon" class="button">
                                                      <input type="hidden" value="{{Session::token()}}" name="_token" />
                                                    </form>
                                                </div>
                                                <form action="cart/{{$item->rowId}}/update" method="post" style="float:right">
                                                        {{csrf_field()}}
                            ...
                            <table cellspacing="0">
                                <tbody>
                                    <tr class="cart-subtotal">
                                        <th>Cart Subtotal</th>
                                        <td>
                                            <span class="amount">{{Cart::total()}}</span></td>
                                    </tr>
